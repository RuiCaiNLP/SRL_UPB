...
def make_parser():
    ...
    parser.add_argument('--dev_pred_acc', type=float, default=0.99,
                        help='Dev predicate disambiguation accuracy')
    parser.add_argument('--test_pred_acc', type=float, default=0.99,
...
if __name__ == '__main__':
    ...
    word2idx = None #data_utils.load_dump_data(os.path.join(os.path.dirname(__file__), 'temp/word2idx.bin'))
    idx2word = None #data_utils.load_dump_data(os.path.join(os.path.dirname(__file__), 'temp/idx2word.bin'))

    fr_word2idx = None #data_utils.load_dump_data(os.path.join(os.path.dirname(__file__), 'temp/fr_word2idx.bin'))
    fr_idx2word = None # data_utils.load_dump_data(os.path.join(os.path.dirname(__file__), 'temp/fr_idx2word.bin'))

    lemma2idx = None #data_utils.load_dump_data(os.path.join(os.path.dirname(__file__), 'temp/lemma2idx.bin'))
    idx2lemma = None #data_utils.load_dump_data(os.path.join(os.path.dirname(__file__), 'temp/idx2lemma.bin'))
    ...
    pretrain2idx = None #data_utils.load_dump_data(os.path.join(os.path.dirname(__file__), 'temp/pretrain2idx.bin'))
    idx2pretrain = None #data_utils.load_dump_data(os.path.join(os.path.dirname(__file__), 'temp/idx2pretrain.bin'))

    fr_pretrain2idx = None #data_utils.load_dump_data(os.path.join(os.path.dirname(__file__), 'temp/fr_pretrain2idx.bin'))
    fr_idx2pretrain = None #data_utils.load_dump_data(os.path.join(os.path.dirname(__file__), 'temp/fr_idx2pretrain.bin'))
    ...
    pretrain_emb_weight = None #data_utils.load_dump_data(os.path.join(os.path.dirname(__file__), 'temp/pretrain.emb.bin'))
    fr_pretrain_emb_weight = None #data_utils.load_dump_data(os.path.join(os.path.dirname(__file__), 'temp/fr_pretrain.emb.bin'))
    ...
    if FLAG == 'TRAIN':
        model_params = {
            ...
            "word_vocab_size": 0,
            "fr_word_vocab_size": 0,
            "lemma_vocab_size": 0,
            "pos_vocab_size": 0,
            "deprel_vocab_size": len(deprel2idx),
            "pretrain_vocab_size": 0,
            "fr_pretrain_vocab_size": 0,
